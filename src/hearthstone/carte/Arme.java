...
public class Arme extends CarteD {
     ...
     */
    public Arme(String nom, int mana, String desc, Rarete rarete, Classe classe, String urlImage, String urlImageDoree, int degats, int durabilite) throws ValeurNegativeException {
     ...
     * @throws ValeurNegativeException si une veleur negative est utilisee pour initialiser une carte
     */
    public Arme(String nom, int mana, String desc, Rarete rarete, Classe classe, int degats, int durabilite) throws ValeurNegativeException {
