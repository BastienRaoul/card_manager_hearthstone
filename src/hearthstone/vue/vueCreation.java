...
public class vueCreation extends JFrame{
	...
	private JButton AjouterCarte = new JButton("Ajouter une carte");

    private JButton creationcarte = new JButton("creer carte");
    private JButton detruirecarte = new JButton("detruire carte");
...
RightTypeGrp.add(RightArme);
RightTypeGrp.add(RightSort);
RightTypeGrp.add(RightServiteur);
...
RightRaceCombo.addItem(Race.DEMON);
RightRaceCombo.addItem(Race.DRAGON);
RightRaceCombo.addItem(Race.ELEMENTAIRE);
RightRaceCombo.addItem(Race.MECA);
RightRaceCombo.addItem(Race.MURLOC);
RightRaceCombo.addItem(Race.PIRATE);
RightRaceCombo.addItem(Race.TOTEM);
subMainRightAjout.add(RightRaceCombo);


RightRareteCombo.addItem(Rarete.BASIQUE);
RightRareteCombo.addItem(Rarete.COMMUNE);
RightRareteCombo.addItem(Rarete.RARE);
RightRareteCombo.addItem(Rarete.EPIQUE);
RightRareteCombo.addItem(Rarete.LEGENDAIRE);
subMainRightAjout.add(RightRareteCombo);
subMainRightAjout.add(Description);
subMainRightAjout.add(Explication);
//////////////////////////
...
subMainRight.add(subMainRightAjout, BorderLayout.CENTER);
subMainRight.add(AjouterCarte, BorderLayout.NORTH);

subMainRightButton.setLayout(new BoxLayout(subMainRightButton,BoxLayout.X_AXIS));
subMainRightButton.add(creationcarte);
subMainRightButton.add(detruirecarte);
subMainRight.add(subMainRightButton, BorderLayout.SOUTH);
