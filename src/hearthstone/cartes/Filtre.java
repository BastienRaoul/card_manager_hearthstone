...
public class Filtre {
	 ...
	 * 
	 * @param desCartes
	 *            la collection de cartes à trier
	 ...
	 * 
	 * @param desCartes
	 *            une collection de cartes à trier
	 * @param rarete
	 *            la rareté utilisée pour filtrer
	 ...
	 * 
	 * @param desCartes
	 *            la collection de cartes "Serviteur" à filtrer
	 * @param race
	 *            la race pour filtrer
	 ...
	 * 
	 * @param desCartes
	 *            la collection de cartes à filtrer
	 ...
	 * @param desCartes
	 *            les cartes à créer
	 * @param valeurCreationDisponible
	 *            la valeur de création disponible
