...
public class TestDeck {
	...
	Deck d = new Deck(new Cartes(), Classe.MAGE, 31, "tesr");
    }
	...
	Deck d = new Deck(new Cartes(), Classe.NEUTRE, 30, "tesr");
    }
	...
	Deck d = new Deck(new Cartes(), Classe.NEUTRE, "tesr");
    }
	...
	Cartes t = new Cartes();
	Deck d = new Deck(t, Classe.GUERRIER, 4, "tesr");
	...
	Deck d = new Deck(new Cartes(), Classe.GUERRIER, "tesr");
	Carte arme0 = new Arme("Marteau Thor", 0, "MarteauThor...", Rarete.LEGENDAIRE, Classe.GUERRIER, 100, 100);
	d.ajouter(arme0);
    }
	...
	Cartes t = new Cartes();
	Deck d = new Deck(t, Classe.GUERRIER, "tesr");
	...
	Cartes t = new Cartes();
	Deck d = new Deck(t, Classe.MAGE, "tesr");
	...
	Cartes t = new Cartes();
	Deck d = new Deck(t, Classe.MAGE, 30, "tesr");
	...
	d.ajouter(arme3);
	d.ajouter(arme4);
	Deck de = new Deck(t, Classe.GUERRIER, "tesr");
	de.ajouter(arme0);
	de.ajouter(arme1);
	de.ajouter(arme2);
	de.ajouter(arme3);
	...
	Deck d = new Deck(tasDeCartes, Classe.GUERRIER, "tesr");
	Deck d2 = new Deck(tasDeCartes, Classe.CHASSEUR, "tesr");
	...
	Cartes tasDeCartes = new Cartes();
	Deck d = new Deck(tasDeCartes, Classe.GUERRIER, -1, "tesr");
    }
	...
	Cartes tasDeCartes = new Cartes();
	Deck d = new Deck(tasDeCartes, Classe.GUERRIER, 30, "tesr");
    }
	...
	Cartes tasDeCartes = new Cartes();
	Carte arme1 = new Arme("arteau Thor", 1, "MarteauThor...", Rarete.BASIQUE, Classe.GUERRIER, 100, 100);
	Deck deck = new Deck(tasDeCartes, Classe.CHAMAN, "tesr");
