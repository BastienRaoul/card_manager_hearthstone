...
// on test le filtre des armes en donnant en paramètre une collection contenant diverses cartes
    @Test
...
//on test le filtre des armes en donnant en paramètre une collection de cartes sans armes
    @Test
...
// on test le filtre des serviteurs en donnant en paramètre une collection contenant diverses cartes
...
//on test le filtre des serviteurs en donnant en paramètre une collection sans serviteurs
    @Test
...
// on test le filtre des sorts en donnant en paramètre une collection contenant diverses cartes
...
//On test le filtre des cartes dorées en donnant en paramètres une collection de diverses cartes, 
//dont une dorée
    @Test
...
//On test le filtre de classe en donnant en paramètre une collection de diverses cartes
...
//On test le filtre de classe en donnant en paramètre une collection contenant diverses cartes
...
//On test le filtre de mana avec une collection contenant deux cartes ayant un total de mana de 15
...
//On test le filtre de mana en mettant en paramètre une collection vide et 0 de mana
    @Test
...
//On test le filtre de gain de désenchantement en mettant en paramètre une collection de
...
//On test le filtre de possibilité de créer en donnant en paramètre true et une collection
//de diverses cartes
    @Test
...
//une collection de cartes diverses, et une collection de dénombrement correspondant aux cartes
...
//on test le filtre de rareté en mettant en aramètre une rareté de carte n'étant pas dans 
//la collection
    @Test
...
//on test le filtre de gain désenchantement pour 0 cartes, avec un résultat attendu de 0 
    @Test
...
//on test le filtre de possibilité de créer pour 0 cartes avec en paramètres true, car 
...
//On test le filtre de possibilité de créer avec en paramètre false pour des cartes trop chères
    @Test
...
//on test le filtre de cartes dénombrées pour une collection vide, on a donc une collection
...
//On test le filtre de dénombrement avec la même arme ayant été créé sous deux noms de variables
//différents, pour vérifier que le dénombrement se fait bien malgré un ajout de deux variables 
